...
- (void)setChoiceType:(NSString *)ChoiceType {
    [self.choiceBtn setTitle:ChoiceType forState:UIControlStateNormal];
...
- (UIButton *)choiceBtn {
    ...
    if (!_choiceBtn) {
        _choiceBtn = [UIButton initButtonTitleFont:18 titleColor:[UIColor hex:@"121212"] titleName:@""];
...
- (UILabel *)answerLabel {
    ...
    if (!_answerLabel) {
        _answerLabel = [UILabel initLabelTextFont:18 textColor:[UIColor hex:@"424242"] title:@""];
