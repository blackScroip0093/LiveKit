...
#define MSG_TABLEVIEW_WIDTH        [UIScreen mainScreen].bounds.size.width - 28
#define MSG_TABLEVIEW_HEIGHT       240
#define MSG_TABLEVIEW_BOTTOM_SPACE 40
#define MSG_TABLEVIEW_LABEL_FONT   18
...
typedef NS_ENUM(NSInteger, TCMsgModelType) {
    ...
    TCMsgModelType_Image            = 6,   //
    TCMsgModelType_TongZhi            = 7,
