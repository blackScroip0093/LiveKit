...
@property (nonatomic, retain) TCAudienceToolbarView *logicBigView;

//@property (nonatomic, retain) TCAudienceToolbarBigView *biglogicView;

@property (nonatomic, retain) TRTCLiveRoom* liveRoom;
@property (nonatomic, assign) BOOL  log_switch;
@property (nonatomic, strong) UIWindow  *videoParentView;
@property (nonatomic, assign) NSInteger  roomStatus;
@property (nonatomic, assign)  BOOL isOwnerEnter;
@property (nonatomic, strong) UIView *videoView;
@property (nonatomic, strong) UIImageView *centerImageView;
@property (nonatomic, strong) loginModel *needDict;
