 ...
 */
@interface TCAudienceToolbarView : UIView <UIImagePickerControllerDelegate, UINavigationControllerDelegate,
    UITextFieldDelegate,
    UIAlertViewDelegate,
...
@property (nonatomic, retain)  UIButton           *bulletBtn1;
...
@property (nonatomic, retain)  UITextField        *msgInputFeild;
@property (nonatomic, retain)  TCMsgListTableView *msgTableView;;
@property (nonatomic, assign) BOOL               bulletBtnIsOn;
@property (nonatomic, weak) TRTCLiveRoom      *liveRoom;
@property (nonatomic, retain)UIView             *msgInputView;
