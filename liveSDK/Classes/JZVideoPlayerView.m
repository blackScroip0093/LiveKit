...
-(id)initWithFrame:(CGRect)frame contentURL:(NSURL *)contentURL{
    ...
    if (self) {
        ...
        self.playerLayer.frame = CGRectMake(0, StatusBarHeight, HPScreenWidth, HPScreenWidth/375*200 - StatusBarHeight );
...
-(void)initControlView{
    ...
    self.playerHUDTopView.hidden = YES;
    ...
    self.playerHUDBottomView.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0];
